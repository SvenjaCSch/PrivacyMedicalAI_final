...
class Symptoms:
    ...
    @staticmethod
    def get_symptoms(row: pd.Series, data:pd.DataFrame, name:str) -> tuple[str, str] | tuple[Any, str | Any] | tuple[Any, Any]:
        """
        Get symptoms based on the gender and the age.
        This way, male patients can't be pregnant and no child gets rheuma as disease in this datasets
        :param row: row from the dataset with age information
        :param data: data with gender information
        :param name: name of the patient
        :return: sample and symptoms
        """
        data = data.copy()
    ...
    def get_symptoms_by_disease(disease:str, symptoms:str, data:pd.DataFrame, gender:str)->str:
        """
        Get symptoms based on the gender and the age and disease
        :param disease: disease of the patient
        :param symptoms: symptoms of the patient
        :param data: data with gender information
