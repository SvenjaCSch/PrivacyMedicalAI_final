...
# -*- coding: utf-8 -*-
"""
Filename: Step3_attacks/general_prompts_defence.py
Author: Svenja C. Schulze
Last Updated: 2025-09-06
Description: get general prompts for the defence
"""
...
from specific_prompts_defense import SpecificPrompts
from generic_prompts_defense import GenericPrompts
import pandas as pd
import torch
from ..allPHI import AllPhis
from ..evaluation import Evaluation
from no_harmful_prompt_defense import NoHarmfulPrompts
...
class Main:
    ...
    def get_results(self, target_patient_names: list, model_name: str, base:str, dataset:str, epoch:str)->None:
        """
        ...
        :return: None
        """
        for target_person_name in target_patient_names:
...
if __name__ == '__main__':
    ...
    for epoch in epochs:
        ...
        models = {f"meerkat_dataset2_epoch{epoch}": meerkat_exp2}
        base1 = f"{BASE_MLCLOUD}/data/prompt_attack_Defence_prefix/"
        ...
        for model_name, model_path in models.items():
            ...
            if "dataset1" in model_name:
                ...
                phi_data = pd.read_csv(
                    ...
                    index_col=0)
                target_persons = main_runner.evaluation.get_patient_names_unique(phi_data)
                target_person_names_df = target_persons.sample(n=5)
