...
# -*- coding: utf-8 -*-
"""
Filename: Step3_attacks/main_exp2.py
Author: Svenja C. Schulze
Last Updated: 2025-09-06
Description: main for the second experiment
"""
...
if __name__ == '__main__':
    ...
    meerkat_dataset1 = f"{BASE_MLCLOUD}/models/meerkat_exp1_epoch20"
    meerkat_dataset2 = f"{BASE_MLCLOUD}/models/meerkat_exp2_epoch20"
    meerkat_dataset3 = f"{BASE_MLCLOUD}/models/meerkat_exp3_epoch20"
    meerkat_dataset4 = f"{BASE_MLCLOUD}/models/meerkat_exp4_epoch20"
    medmobile_dataset1 = f"{BASE_MLCLOUD}/models/medmobile_exp1_epoch20"
    medmobile_dataset2 = f"{BASE_MLCLOUD}/models/medmobile_exp2_epoch20"
    medmobile_dataset3 = f"{BASE_MLCLOUD}/models/medmobile_exp3_epoch20"
    medmobile_dataset4 = f"{BASE_MLCLOUD}/models/medmobile_exp4_epoch20"
    models = {"meerkat_dataset4": meerkat_dataset4,
              "medmobile_dataset1": medmobile_dataset1, "medmobile_dataset2": medmobile_dataset2,
              "medmobile_dataset3": medmobile_dataset3, "medmobile_dataset4": medmobile_dataset4}
    base1 = f"{BASE_MLCLOUD}/data/prompt_attack_Experiment2_10_examples"
    #"meerkat_dataset1": meerkat_dataset1, "meerkat_dataset2": meerkat_dataset2,"meerkat_dataset3": meerkat_dataset3,
    ...
    for model_name, model_path in models.items():
        ...
        if "dataset1" in model_name:
            ...
            target_person_names_df = target_persons.sample(n=10, random_state=42)
