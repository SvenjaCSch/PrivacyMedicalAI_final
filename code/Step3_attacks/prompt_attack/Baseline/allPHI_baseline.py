...
# -*- coding: utf-8 -*-
"""
Filename: Step3_attacks/allPHI_baseline.py
...
class AllPHIs:
    ...
    def make_dataframes(self, original_extracted_data: dict, prompt_text: str, accuracy_dataframe: pd.DataFrame,
                        person_specific_phi_data: pd.DataFrame = None,
