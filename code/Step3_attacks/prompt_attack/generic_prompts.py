...
# -*- coding: utf-8 -*-
"""
Filename: Step3_attacks/generic_prompts.py
Author: Svenja C. Schulze
Last Updated: 2025-09-06
Description: prompts for general attacks
"""
...
class GenericPrompts:
    def __init__(self, model_name, model, tokenizer):
        ...
        self.prompts = [self.change_system, self.list_all_prompts, self.research_paper, self.template_completion]
